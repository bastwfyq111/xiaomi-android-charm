...
export default function JournalTab() {
  ...
  const renderEntryRow = (l: EntryLine, idx: number, total: number) => {
    ...
    return (
      ...
      >
        <td className="!whitespace-nowrap text-center !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs">
          <span
        ...
        <td className="min-w-[210px] !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs whitespace-nowrap">
          <AccountDropdownCell
            value={l.account}
        ...
        <td className="min-w-[180px] !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs whitespace-nowrap">
          <input
            type="text"
            value={l.description || ""}
        ...
        <td className="w-[130px] !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs whitespace-nowrap">
          <input
            type="number"
            inputMode="decimal"
            dir="ltr"
        ...
        <td className="w-[52px] text-center !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs whitespace-nowrap">
          {total > 1 && (
            <button
        ...
        <div className="space-y-4 p-3 sm:p-4">
          ...
          <div className="overflow-hidden rounded-2xl border border-slate-200">
            <div className="overflow-x-auto">
              <table className="w-max min-w-[640px] table-auto border-collapse text-right text-sm sm:text-base">
                <thead className="bg-[#0e2b40] text-white">
                  <tr>
                    <th className="!whitespace-nowrap text-center font-bold !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs">
                      #
                    </th>
                    <th className="!whitespace-nowrap text-right font-bold !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs">
                      الحساب
                    </th>
                    <th className="!whitespace-nowrap text-right font-bold !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs">
                      بيان السطر
                ...
                <tfoot>
                  <tr className="border-t border-slate-200 bg-slate-50">
                    <td colSpan={5} className="!px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs whitespace-nowrap">
        ...
        {journal.length === 0 ? (
          ...
          <>
            <div className="max-h-[60vh] overflow-auto">
              <table className="w-max min-w-[860px] table-auto border-collapse text-center text-sm sm:text-base">
                <thead className="sticky top-0 z-20 bg-[#0e2b40] text-white shadow-md">
                  <tr>
                    {[
                      ...
                      <th
                        key={h}
                        className="!whitespace-nowrap border-b border-white/10 text-center font-bold !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs"
                      >
                        {h}
                      </th>
                    ))}
                ...
                <tbody>
                  {journal.map((j) => (
                    ...
                    >
                      <td className="!whitespace-nowrap font-mono text-slate-600 !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs">
                        {j.formNo || "—"}
                      </td>
                      <td className="!whitespace-nowrap text-slate-600 !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs">
                        {j.settlement || "—"}
                      </td>
                      <td className="!whitespace-nowrap font-mono text-slate-600 !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs">
                        {j.date || "—"}
                      ...
                      <td
                        className="max-w-[260px] truncate font-medium text-slate-800 !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs whitespace-nowrap"
                        title={j.description}
                      >
                        {j.description || "—"}
                      </td>
                      ...
                      <td className="!whitespace-nowrap font-mono font-black text-emerald-700 !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs">
                        {j.debit ? j.debit.toLocaleString("en-US") : "—"}
                      </td>
                      <td className="!whitespace-nowrap font-mono font-black text-rose-700 !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs">
                        {j.credit ? j.credit.toLocaleString("en-US") : "—"}
                      </td>
                      <td className="whitespace-nowrap !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs">
                ...
                <tfoot className="sticky bottom-0 bg-[#f5f2ea]">
                  <tr className="border-t-2 border-[#c99a4e]/60">
                    <td colSpan={6} className="text-right font-bold text-slate-700 !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs whitespace-nowrap">
                      الإجمالي
                    </td>
                    <td className="font-mono font-black text-emerald-800 !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs whitespace-nowrap">
                      {grandDebit.toLocaleString("en-US")}
                    </td>
                    <td className="font-mono font-black text-rose-800 !px-0.5 !py-1 sm:!px-1 sm:!py-1 !text-[10px] sm:!text-xs whitespace-nowrap">

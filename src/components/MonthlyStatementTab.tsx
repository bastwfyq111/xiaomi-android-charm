    ...
    <div className="space-y-5" dir="rtl">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <div className="overflow-auto max-h-[65vh] relative">
          <table ref={tableRef1} className="w-max min-w-full table-auto text-sm sm:text-base border-collapse text-center">
            <thead className="bg-slate-100 text-slate-800 font-bold border-b border-black sticky top-0 z-20 shadow-sm">
              <tr>
                <th
                  rowSpan={2}
                  className="border border-black text-center bg-slate-100 text-slate-900 font-extrabold break-words !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap"
                >
                  بيان الحسابات (طبقاً للنظام المحاسبي الموحد)
                </th>
                <th
                  colSpan={2}
                  className="border border-black text-center bg-slate-200/60 font-bold text-slate-800 !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap"
                >
                ...
                <th
                  colSpan={2}
                  className="border border-black text-center bg-teal-50 text-teal-900 font-bold !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap"
                >
                  {movementLabel}
                </th>
                <th
                ...
                <th
                  colSpan={2}
                  className="border border-black text-center bg-amber-50 text-amber-900 font-extrabold !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap"
                >
              ...
              <tr className="bg-slate-50 text-xs text-slate-600 border-b border-black">
                <th className="border border-black text-center font-semibold bg-slate-50 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                  إيرادات / مدين
                </th>
                <th className="border border-black text-center font-semibold bg-slate-50 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                  مصروفات / دائن
                </th>
                <th className="border border-black text-center font-semibold bg-teal-50/50 text-teal-950 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                  إيرادات / مدين
                </th>
                <th className="border border-black text-center font-semibold bg-teal-50/50 text-teal-950 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                  مصروفات / دائن
                ...
                <th className="border border-black text-center font-bold bg-amber-50/50 text-amber-950 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                  أرصدة مدينة
                </th>
                <th className="border border-black text-center font-bold bg-amber-50/50 text-amber-950 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                  أرصدة دائنة
            ...
            <tbody className="divide-y divide-black">
                ...
                return (
                  <Fragment key={g.title}>
                    <tr className="bg-slate-100/80 font-bold">
                      <td
                        colSpan={9}
                        className="border border-black text-center text-slate-900 font-bold bg-slate-200/50 !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap"
                      >
                        📁 {g.title}
                      </td>
                    </tr>
                    {g.accounts.map((a) => {
                      ...
                      return (
                        <tr key={a} className="hover:bg-slate-50/80 transition-colors">
                          <td className="border border-black font-medium text-slate-700 text-center min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                            {a}
                          </td>
                          <td className="border border-black font-mono text-center text-slate-600 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                            {r.prevDebit ? fmt(r.prevDebit) : "—"}
                          </td>
                          <td className="border border-black font-mono text-center text-slate-600 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                            {r.prevCredit ? fmt(r.prevCredit) : "—"}
                          </td>
                          <td className="border border-black font-mono text-center text-teal-700 bg-teal-50/10 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                            {r.curDebit ? fmt(r.curDebit) : "—"}
                          </td>
                          <td className="border border-black font-mono text-center text-teal-700 bg-teal-50/10 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                            {r.curCredit ? fmt(r.curCredit) : "—"}
                          </td>
                          <td className="border border-black font-mono text-center text-slate-800 font-medium min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                            {totD ? fmt(totD) : "—"}
                          </td>
                          <td className="border border-black font-mono text-center text-slate-800 font-medium min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                            {totC ? fmt(totC) : "—"}
                          </td>
                          <td className="border border-black font-mono text-center text-emerald-700 font-bold bg-emerald-50/20 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                            {balD ? fmt(balD) : "—"}
                          </td>
                          <td className="border border-black font-mono text-center text-rose-700 font-bold bg-rose-50/20 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                            {balC ? fmt(balC) : "—"}
                          </td>
                        </tr>
                      );
                    ...
                    <tr className="bg-slate-50 font-bold text-slate-900 border-b border-black">
                      <td className="border border-black text-center text-slate-800 font-bold min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                        جملة بند: {g.title}
                      </td>
                      <td className="border border-black font-mono text-center text-slate-700 bg-slate-100/50 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                        {fmt(gPD)}
                      </td>
                      <td className="border border-black font-mono text-center text-slate-700 bg-slate-100/50 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                        {fmt(gPC)}
                      </td>
                      <td className="border border-black font-mono text-center text-teal-800 bg-teal-50/40 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                        {fmt(gCD)}
                      </td>
                      <td className="border border-black font-mono text-center text-teal-800 bg-teal-50/40 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                        {fmt(gCC)}
                      </td>
                      <td className="border border-black font-mono text-center text-slate-900 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                        {fmt(gPD + gCD)}
                      </td>
                      <td className="border border-black font-mono text-center text-slate-900 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                        {fmt(gPC + gCC)}
                      </td>
                      <td className="border border-black font-mono text-center text-emerald-800 bg-emerald-100/20 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                        {fmt(Math.max(0, gPD + gCD - (gPC + gCC)))}
                      </td>
                      <td className="border border-black font-mono text-center text-rose-800 bg-rose-100/20 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
              ...
              <tr className="bg-slate-900 text-white font-extrabold text-sm border-t-2 border-black">
                <td className="border border-black text-center bg-slate-950 font-black min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                  الإجمالي العام النهائي للحسابات الكلية
                </td>
                <td className="border border-black font-mono text-center text-slate-200 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                  {fmt(totals.prevDebit)}
                </td>
                <td className="border border-black font-mono text-center text-slate-200 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                  {fmt(totals.prevCredit)}
                </td>
                <td className="border border-black font-mono text-center text-teal-300 bg-slate-800 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                  {fmt(totals.curDebit)}
                </td>
                <td className="border border-black font-mono text-center text-teal-300 bg-slate-800 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                  {fmt(totals.curCredit)}
                </td>
                <td className="border border-black font-mono text-center text-slate-100 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                  {fmt(totals.prevDebit + totals.curDebit)}
                </td>
                <td className="border border-black font-mono text-center text-slate-100 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                  {fmt(totals.prevCredit + totals.curCredit)}
                </td>
                <td className="border border-black font-mono text-center text-emerald-400 bg-teal-950/50 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                  {fmt(
                    Math.max(
                      0,
                ...
                <td className="border border-black font-mono text-center text-rose-400 bg-teal-950/50 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                  {fmt(
                    Math.max(
                      0,
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <div className="overflow-auto max-h-[50vh] relative">
          <table ref={tableRef2} className="w-max min-w-full table-auto text-sm sm:text-base border-collapse text-center">
            <thead className="bg-teal-50 text-teal-900 font-bold border-b border-black sticky top-0 z-20 shadow-sm">
              <tr>
                <th className="border border-black text-center min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                  م
                </th>
                <th className="border border-black text-center min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                  رمز الإيراد
            ...
            <tbody className="divide-y divide-black">
              {revenueByCode.length === 0 ? (
                <tr>
                  <td colSpan={7} className="text-center text-slate-500 font-medium !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                ...
                revenueByCode.map((r, i) => (
                  <tr key={r.code} className="hover:bg-teal-50/40 transition-colors">
                    <td className="border border-black text-center font-mono text-slate-500 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                      {i + 1}
                    </td>
                    <td className="border border-black text-center font-mono font-extrabold text-teal-800 bg-teal-50/40 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                      {r.code}
                    </td>
                    <td className="border border-black text-center font-medium text-slate-800 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                      {r.label}
                    </td>
                    <td className="border border-black text-center font-mono text-slate-600 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                      {r.count}
                    </td>
                    <td className="border border-black text-center font-mono text-slate-700 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                      {r.prev ? fmt(r.prev) : "—"}
                    </td>
                    <td className="border border-black text-center font-mono text-teal-700 font-bold bg-teal-50/30 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                      {r.cur ? fmt(r.cur) : "—"}
                    </td>
                    <td className="border border-black text-center font-mono text-emerald-700 font-black bg-emerald-50/30 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                      {fmt(r.total)}
                    </td>
                  </tr>
                ))
            ...
            {revenueByCode.length > 0 && (
              <tfoot>
                <tr className="bg-slate-900 text-white font-extrabold">
                  <td
                    colSpan={3}
                    className="border border-black text-center !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap"
                  >
                    الإجمالي العام لرموز الإيراد
                  </td>
                  <td className="border border-black text-center font-mono min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                    {revenueTotals.count}
                  </td>
                  <td className="border border-black text-center font-mono text-slate-200 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                    {fmt(revenueTotals.prev)}
                  </td>
                  <td className="border border-black text-center font-mono text-teal-300 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">
                    {fmt(revenueTotals.cur)}
                  </td>
                  <td className="border border-black text-center font-mono text-emerald-400 min-w-[120px] whitespace-nowrap overflow-hidden !p-1 sm:!p-2 !text-xs sm:!text-sm">

      ...
      <div className="accounts-print-area w-full bg-white rounded-2xl overflow-hidden border border-black/10 shadow-sm">
        ...
        <div className="p-3">
          <div className="overflow-x-auto overflow-y-auto max-h-[550px] relative rounded-xl">
            <table className="w-max min-w-full table-auto text-sm sm:text-base text-right border-collapse border-2 border-black table-auto">
              <thead className="sticky top-0 z-20 text-[#171412] font-black text-[13px] bg-[#E7E2D8]">
                <tr>
                  <th className="border border-black text-center w-10 bg-[#E7E2D8] sticky top-0 z-20 !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                    م
                  </th>
                  {COLS.map((c) => (
                    <th
                      key={c.key}
                      className="border border-black min-w-[80px] cursor-pointer hover:bg-[#DCD5C6] transition-colors select-none sticky top-0 z-20 bg-[#E7E2D8] !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap"
                  ...
                  <th className="border border-black text-center bg-[#E7E2D8] sticky top-0 z-20 min-w-[60px] !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                    إجراءات
                  </th>
                </tr>
                <tr className="accounts-print-hide bg-[#F2EFEA]">
                  <th className="border border-black bg-[#F2EFEA] !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap"></th>
                  {COLS.map((c) => (
                    <th key={c.key} className="border border-black bg-[#F2EFEA] !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                      <input
                        value={filters[c.key] || ""}
                ...
                {filteredWithBalance.length === 0 ? (
                  <tr>
                    <td
                      ...
                      className="text-center font-black border border-black bg-white !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap"
                    >
                  ...
                  filteredWithBalance.map((acc, index) => (
                    <tr key={acc.id} className="odd:bg-white even:bg-[#FAF9F6] hover:bg-[#F0EBDE] transition-colors group">
                      <td className="border border-black text-center font-mono tabular-nums !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                        {index + 1}
                      </td>
                      <td className="border border-black font-mono tabular-nums min-w-[85px] text-center !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                        {acc.date}
                      </td>
                      <td className="border border-black font-mono tabular-nums font-black text-center !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                        {acc.hafizaNo || "—"}
                      </td>
                      <td className="border border-black font-mono tabular-nums text-center !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                        {acc.notifyNo || "—"}
                      </td>
                      <td className="border border-black font-mono tabular-nums min-w-[85px] text-center !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                        {acc.notifyDate || "—"}
                      ...
                      <td className="border border-black min-w-[140px] !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                        {acc.description || "—"}
                      </td>
                      <td className="border border-black min-w-[100px] !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                        {acc.specialty || "—"}
                      </td>
                      <td className="border border-black font-black min-w-[120px] !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                        {acc.name || "—"}
                      </td>
                      <td className="border border-black font-mono tabular-nums text-center !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                        {Number(acc.hafizaAmount) > 0 ? fmt(Number(acc.hafizaAmount)) : "—"}
                      </td>
                      <td className="border border-black font-mono tabular-nums font-black text-center bg-[#1E8E5A]/[0.06] !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                        {Number(acc.income) > 0 ? fmt(Number(acc.income)) : "—"}
                      </td>
                      <td className="border border-black font-mono tabular-nums font-black text-center bg-[#D14343]/[0.06] !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                        {Number(acc.expense) > 0 ? fmt(Number(acc.expense)) : "—"}
                      </td>

                      <td className="accounts-print-hide border border-black text-center min-w-[110px] !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                        <select
                      ...
                      <td className="border border-black font-mono tabular-nums font-black text-center bg-[#2563AC]/[0.06] !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                        {fmt(acc.balance)}
                      </td>
                      <td className="accounts-print-hide border border-black text-center !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
              ...
              {filteredWithBalance.length > 0 && (
                <tfoot>
                  <tr className="bg-[#E7E2D8]">
                    <td colSpan={10} className="border border-black text-left font-black !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                      رصيد الإقفال
                    </td>
                    <td className="border border-black font-mono tabular-nums font-black text-center !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                      {fmt(totalIncome)}
                    ...
                    <td className="border border-black font-mono tabular-nums font-black text-center bg-[#2563AC]/10 !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap">
                      {fmt(currentBalance)}
                    </td>
                    <td className="accounts-print-hide border border-black !p-1 sm:!p-2 !text-xs sm:!text-sm whitespace-nowrap"></td>
                  </tr>
                </tfoot>
              )}
            </table>

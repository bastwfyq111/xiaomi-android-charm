          ...
          <button
            onClick={() => {
              ...
              w.document
                ...
                th,td{border:1px solid black;padding:4px 6px;text-align:center;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;overflow-wrap:normal;word-break:normal;color:whait !important;font-weight:1000 !important}

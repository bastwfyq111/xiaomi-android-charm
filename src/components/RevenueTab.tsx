          ...
          <table className="w-full text-right border-collapse text-xs md:text-sm border border-black">
            <thead className="sticky top-0 z-20 shadow-sm">
              <tr className="bg-slate-100 text-slate-700 font-bold border-b-2 border-black">
                <th rowSpan={2} className="border border-black p-3 text-right whitespace-nowrap">
                  بيان مفردات الموارد المعتمدة
                </th>
                <th rowSpan={2} className="border border-black p-3 text-center whitespace-nowrap">
                  الباب
                </th>
                <th rowSpan={2} className="border border-black p-3 text-center whitespace-nowrap">
                  الفصل
                ...
                <th
                  colSpan={2}
                  className="border border-black p-2 text-center bg-teal-50/50 text-teal-900 whitespace-nowrap"
                >
                  الشهر الجاري
                </th>
                <th
                  colSpan={2}
                  className="border border-black p-2 text-center bg-slate-50 text-slate-800 whitespace-nowrap"
                >
                  الأشهر السابقة
                </th>
                <th
                  colSpan={2}
                  className="border border-black p-2 text-center bg-emerald-50/50 text-emerald-900 whitespace-nowrap"
                >
                  الجملــة والتراكمي
                </th>
              </tr>
              <tr className="bg-slate-50 text-slate-500 font-bold border-b-2 border-black">
                <th className="border border-black p-2 text-center whitespace-nowrap">ف</th>
                <th className="border border-black p-2 text-center whitespace-nowrap">ريال</th>
                <th className="border border-black p-2 text-center whitespace-nowrap">ف</th>
                <th className="border border-black p-2 text-center whitespace-nowrap">ريال</th>
                <th className="border border-black p-2 text-center whitespace-nowrap">ف</th>
                <th className="border border-black p-2 text-center whitespace-nowrap">ريال</th>
            ...
            <tbody className="font-medium">
              ...
              <tr className="bg-teal-700/[0.04] font-bold text-teal-950 border-b-2 border-black">
                <td className="border border-black p-3 text-right font-cairo whitespace-nowrap">
                  إجمالي الموارد العامة للوحدة
                </td>
                <td colSpan={4} className="border border-black"></td>
                <td className="border border-black"></td>
                <td className="border border-black p-3 font-mono text-left text-teal-700 whitespace-nowrap">
                  {cellNum(data.grandCur)}
                </td>
                <td className="border border-black"></td>
                <td className="border border-black p-3 font-mono text-left text-slate-600 whitespace-nowrap">
                  {cellNum(data.grandPrev)}
                </td>
                <td className="border border-black"></td>
                <td className="p-3 font-mono text-left text-emerald-700 bg-emerald-50/30 border border-black whitespace-nowrap">
                ...
                ch.sections.length === 0 ? null : (
                  <Fragment key={`ch-${ch.no}`}>
                    ...
                    <tr className="bg-slate-100/80 font-bold text-slate-900 border-b border-black">
                      <td className="border border-black p-3 text-right text-teal-900 font-cairo whitespace-nowrap">
                        {ch.longTitle || ch.title}
                      </td>
                      <td className="border border-black p-3 text-center font-bold text-sm text-teal-800 bg-teal-50/20 whitespace-nowrap">
                        {ch.no}
                      </td>
                      <td colSpan={3} className="border border-black"></td>
                      <td className="border border-black"></td>
                      <td className="border border-black p-3 font-mono text-left whitespace-nowrap">
                      ...
                      <td className="border border-black"></td>
                      <td className="p-3 font-mono text-left bg-slate-200/40 border border-black whitespace-nowrap">
                    ...
                    {ch.sections.map((sec) => (
                      <Fragment key={`sec-${ch.no}-${sec.no}`}>
                        ...
                        <tr className="bg-slate-50 font-semibold text-slate-800 border-b border-black">
                          <td className="border border-black pr-6 p-2 text-right text-slate-700 whitespace-nowrap">
                            {sec.title}
                          </td>
                          <td className="border border-black"></td>
                          <td className="border border-black p-2 text-center text-slate-600 whitespace-nowrap">
                            {sec.no}
                          </td>
                          <td colSpan={2} className="border border-black"></td>
                          <td className="border border-black"></td>
                          <td className="border border-black p-2 font-mono text-left text-slate-600 whitespace-nowrap">
                            {cellNum(data.sectionsAgg[`${ch.no}-${sec.no}`].cur)}
                          </td>
                          <td className="border border-black"></td>
                          <td className="border border-black p-2 font-mono text-left text-slate-500 whitespace-nowrap">
                            {cellNum(data.sectionsAgg[`${ch.no}-${sec.no}`].prev)}
                          </td>
                          <td className="border border-black"></td>
                          <td className="p-2 font-mono text-left text-slate-700 border border-black whitespace-nowrap">
                        ...
                        {sec.items.map((it) => (
                          <Fragment key={`it-${ch.no}-${sec.no}-${it.no}`}>
                            ...
                            <tr className="bg-white text-slate-700 border-b border-black">
                              <td className="border border-black pr-10 p-2 text-right text-slate-600 whitespace-nowrap">
                                {it.title}
                              </td>
                              <td colSpan={2} className="border border-black"></td>
                              <td className="border border-black p-2 text-center text-slate-500 whitespace-nowrap">
                                {it.no}
                              </td>
                              <td className="border border-black"></td>
                              <td className="border border-black"></td>
                            ...
                            {it.types.map((t) => {
                              ...
                              return (
                                ...
                                >
                                  <td className="border border-black pr-14 p-2 text-right text-slate-500 whitespace-nowrap">
                                    {t.title}
                                  </td>
                                  <td colSpan={3} className="border border-black"></td>
                                  <td className="border border-black p-2 text-center text-slate-400 whitespace-nowrap">
                                    {t.no}
                                  </td>
                                  <td className="border border-black"></td>

                                  {/* خانة إدخال المبلغ للشهر الجاري المعدلة بصرياً بالكامل */}
                                  <td className="border border-black p-1.5 bg-teal-50/10 whitespace-nowrap">
                                  ...
                                  <td className="border border-black"></td>
                                  <td className="p-2 font-mono text-left text-slate-800 font-semibold border border-black whitespace-nowrap">
                                    {cellNum(v.tot)}
                                  </td>
                                </tr>
                              );
              ...
              <tr className="bg-slate-100 font-bold text-slate-800 border-t-2 border-black border-b border-black">
                <td
                  colSpan={5}
                  className="p-4 text-center text-sm font-cairo bg-slate-200/50 text-slate-900 border-l border-black whitespace-nowrap"
                >
                  ملخص وعصارة مجاميع الحسابات والأبواب
                </td>
                <td colSpan={6} className="p-0 border border-black"></td>
              </tr>
              {SCHEMA.chapters.map((ch) => {
                ...
                return (
                  ...
                  >
                    <td
                      colSpan={5}
                      className="border border-black p-3 text-right whitespace-nowrap"
                    >
                    ...
                    <td className="border border-black"></td>
                    <td className="border border-black p-3 font-mono text-left text-slate-500 whitespace-nowrap">
                      {cellNum(agg.prev)}
                    </td>
                    <td className="border border-black"></td>
                    <td className="p-3 font-mono text-left text-slate-900 bg-slate-200/30 border border-black whitespace-nowrap">
                      {cellNum(agg.tot)}
                    </td>
                  </tr>
                );
              ...
              <tr className="bg-gradient-to-r from-teal-50 to-emerald-50 font-black text-teal-950 border-t-4 border-black">
                <td
                  colSpan={5}
                  className="border border-black p-4 text-right text-sm font-cairo tracking-wide text-teal-900 whitespace-nowrap"
                >
                  الإجمالي العام والنهائي لجميع موارد المجلس
                </td>
                <td className="border border-black"></td>
                <td className="border border-black p-4 font-mono text-left text-teal-700 text-base whitespace-nowrap">
                  {cellNum(data.grandCur)}
                </td>
                <td className="border border-black"></td>
                <td className="border border-black p-4 font-mono text-left text-slate-600 text-base whitespace-nowrap">
                  {cellNum(data.grandPrev)}
                </td>
                <td className="border border-black"></td>
                <td className="p-4 font-mono text-left text-emerald-800 bg-emerald-50 text-base border border-black whitespace-nowrap">
                  {cellNum(data.grandCur + data.grandPrev)}
                </td>
              </tr>
            </tbody>
